...
const api: ChatApi = {
  ...
  getDispatchRecommendation: (taskId) => ipcRenderer.invoke('get-dispatch-recommendation', taskId),
  dispatchTask: (taskId, rec) => ipcRenderer.invoke('dispatch-task', taskId, rec),
